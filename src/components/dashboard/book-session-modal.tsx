...
function BookSessionModal({
  ...
  const providersQuery = useQuery({
    ...
    queryFn: () => apiFetch<ApiProvider[]>("/api/providers?role=THERAPIST&take=10"),
                    ...
                    {stepLabels.map((label, index) => {
                      ...
                      return (
                        <div key={label} className="flex gap-3">
                          ...
                          <p
                            className={`pb-6 text-sm font-semibold leading-snug ${active ? "text-text-secondary" : "text-text-primary/45"
                              }`}
                          >
                            {label}
                          </p>
                  ...
                  <div className="flex flex-col border-b border-accent/60 bg-[#f4f1ec] px-5 py-3.5 md:hidden">
                    ...
                    <div className="flex gap-1.5 w-full mt-3" aria-hidden="true">
                      {stepLabels.map((_, idx) => (
                        <div
                          key={idx}
                          className={`h-1.5 flex-1 rounded-full transition-all duration-300 ${idx <= step ? "bg-text-secondary" : "bg-text-primary/10"
                            }`}
                        />
                      ))}
                    </div>
                      ...
                      <div className="mx-auto max-w-2xl pr-2 pt-2 text-left">
                        ...
                        <div className="mt-8 grid gap-6 sm:grid-cols-3">
                          ...
                          <button
                            ...
                            className={`flex flex-col items-start rounded-3xl border p-6 text-left transition duration-300 shadow-soft cursor-pointer ${selectedBookingOption === "SESSION"
                          ...
                          <button
                            ...
                            className={`flex flex-col items-start rounded-3xl border p-6 text-left transition duration-300 shadow-soft cursor-pointer ${selectedBookingOption === "PACKAGE"
                          ...
                          <button
                            ...
                            className={`flex flex-col items-start rounded-3xl border p-6 text-left transition duration-300 shadow-soft cursor-pointer ${selectedBookingOption === "MATCHMAKING"
                                  ...
                                  {therapistPackagesQuery.data?.map((pkg) => {
                                    ...
                                    return (
                                      <button
                                        ...
                                        className={`border rounded-calm p-4 text-left transition flex flex-col justify-between h-40 w-full cursor-pointer ${active
                                      ...
                                      >
                                        ...
                                        <div className="mt-3 border-t border-accent/40 pt-3 flex items-center justify-between w-full">
                                          ...
                                          <span className={`text-[10px] font-bold rounded-full px-3 py-1 ${active ? "bg-[#2f745f] text-white" : "bg-accent/40 text-text-primary"
                                            }`}>
                                  ...
                                  return (
                                    ...
                                    >
                                      ...
                                      <div className="mt-3 border-t border-accent/40 pt-3 flex items-center justify-between w-full">
                                        ...
                                        <span className={`text-[10px] font-bold rounded-full px-3 py-1 ${active ? "bg-text-secondary text-white" : "bg-accent/40 text-text-primary"
                                          }`}>
                                          {active ? "Selected" : "Select"}
                                        </span>
                                      </div>
                                ...
                                {MOOD_OPTIONS.map((option) => {
                                  ...
                                  return (
                                    <motion.button
                                      ...
                                      whileTap={{ scale: 0.97 }}
                                      className={`flex items-center gap-2.5 rounded-full border px-5 py-3 text-sm font-semibold transition-[border-color,box-shadow,background-color] duration-300 shadow-soft ${active
                                  ...
                                  filteredProviders.map((provider, index) => {
                                    ...
                                    return (
                                      <motion.button
                                        ...
                                        className={`flex items-center gap-3 rounded-calm border px-3 py-3 text-left shadow-soft transition-[border-color,box-shadow] duration-500 ease-[cubic-bezier(0.4,0,0.2,1)] ${active
                                    ...
                                    {weeklyFreeSlots.map((slot) => {
                                      ...
                                      return (
                                        <button
                                          ...
                                          className={`rounded-full px-4 py-2 text-xs font-semibold transition-colors ${selected
                                ...
                                {(
                                  ...
                                  return (
                                    <button
                                      ...
                                      className={`flex flex-col items-start gap-2.5 rounded-2xl border p-4 text-left cursor-pointer transition ${active
