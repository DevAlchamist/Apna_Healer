    ...
    <div className="relative" ref={ref}>
      ...
      {open ? (
        <div className="absolute right-0 z-20 mt-1 min-w-[180px] rounded-xl border border-[#ebe8e2] bg-white py-1 shadow-[0_12px_32px_-12px_rgba(0,0,0,0.18)]">
          <button
            type="button"
            className="block w-full px-4 py-2 text-left text-sm text-[#3d4543] hover:bg-[#f8f6f2]"
            onClick={(e) => {
              e.stopPropagation();
              onViewRegistrations();
              setOpen(false);
    ...
    <div className="space-y-8">
      ...
      <div className="overflow-hidden rounded-[20px] border border-[#ebe8e2] bg-white shadow-[0_12px_40px_-28px_rgba(0,0,0,0.14)]">
        {eventsQuery.isLoading ? (
          ...
          <div className="px-8 py-16 text-center">
            <p className="font-semibold text-[#1f2827]">No events match your filters</p>
            <button
              type="button"
              onClick={() => setIsCreateOpen(true)}
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-4 py-4">
                        ...
                        {event.clubTitle ? (
                          <p className="mt-0.5 text-xs text-[#2f745f]">{event.clubTitle}</p>
                        ) : null}
                      </td>
                      <td className="px-4 py-4">
                        ...
                        <div className="mt-2 h-1.5 overflow-hidden rounded-full bg-[#f0f0ed]">
                          <div
                            className={`h-full rounded-full transition-all ${
                              isFull ? "bg-[#c44f3f]" : pct >= 80 ? "bg-[#2f745f]" : "bg-[#8ab5a5]"
                            }`}
      ...
      {selected ? (
        ...
        >
          ...
          <p className="mt-4 text-sm text-[#6b7573]">
