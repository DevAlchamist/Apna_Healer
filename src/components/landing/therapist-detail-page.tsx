...
export function TherapistDetailPage() {
  ...
  const specializations = useMemo(() => {
    const fromProfile = therapist?.specializations?.filter(Boolean) ?? [];
    return fromProfile.length > 0 ? fromProfile : DEFAULT_SPECIALIZATIONS;
          ...
          <>
            ...
            >
              <div>
                ...
                >
                  Guide, healer, and companion in your path to emotional equilibrium.{" "}
                  {name} specializes in bridging the gap between clinical excellence and
                  soulful empathy.
                  {therapist.bio ? ` ${therapist.bio.slice(0, 200)}` : ""}
                </motion.p>
                <motion.div
            ...
            >
              ...
              <h2 className="mt-6 font-display text-3xl font-semibold leading-snug text-[#1f2827] md:text-4xl lg:text-5xl">
                &ldquo;Healing is not about fixing what is broken, but discovering the
                wholeness that was always there.&rdquo;
              </h2>
            ...
            <section className="mt-20 grid gap-6 lg:grid-cols-2">
              ...
              >
                ...
                <p className="mt-4 leading-relaxed text-[#5f6b69]">
                  Dedicated to clinical practice with a focus on trauma, anxiety, and
                  behavioral patterns—holding space for growth across every stage of life.
                </p>
              ...
              <div className="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
                <div>
                  ...
                  <p className="mt-4 max-w-xl text-lg italic leading-relaxed text-[#5f4a42]">
                    &ldquo;Working with {lastName} felt like finally finding a compass in a
                    storm. They don&apos;t just listen; they hear the things you haven&apos;t
                    found words for yet.&rdquo;
                  </p>
                ...
                <div className="flex gap-4">
                  ...
                  <div className="rounded-2xl bg-white px-6 py-5 text-center shadow-sm">
                    <p className="text-3xl font-bold text-[#1f2827]">98%</p>
                    <p className="mt-1 text-[10px] font-semibold uppercase tracking-wider text-[#687471]">
                      Retention
                    </p>
                  </div>
